...
class TestCardValidat extends StatefulWidget {
  @override
  _TestCardValidatState createState() => _TestCardValidatState();
}

class _TestCardValidatState extends State<TestCardValidat> {
